...
from vectorstore.figures.getFiguresFromAWS import get_figures_from_AWS
import re
import pandas as pd
...
def get_context_for_MMD_figure_descriptions(main_text, keys_text, context_size=100, skip_forward=50):
    ...
    df_images = get_figures_from_AWS(bucket_name = 'ccber-tester-bucket', aws_folder = 'MMD-Figures/', source_title='MMD', source_year='2022', source_author='Danforth, Bryan, et al.', source_publisher='MMDPublisher')
